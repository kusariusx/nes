...
test_increment_coarse_x :: proc(t: ^testing.T) {
    ...
    // Basic case
    ppu = PPU{timing = console_timing_for_mode(.NTSC), v = 5} // Coarse X = 5
    ppu_increment_coarse_x(&ppu)
    testing.expect_value(t, ppu.v, 6)

    // Wrapping at 31
    ppu = PPU{timing = console_timing_for_mode(.NTSC), v = 31} // Coarse X = 31
    ppu_increment_coarse_x(&ppu)
    testing.expect_value(t, ppu.v, 0x0400) // Coarse X = 0, horizontal nametable bit flipped

    // Preserve other bits
    ppu = PPU{timing = console_timing_for_mode(.NTSC), v = 0x7FFF} // All bits set (coarse X = 31, everything else = 1)
    ppu_increment_coarse_x(&ppu)
...
test_increment_y :: proc(t: ^testing.T) {
    ...
    ppu = PPU{timing = console_timing_for_mode(.NTSC), v = 0x3000} // Fine Y = 3
    ppu_increment_y(&ppu)
    testing.expect_value(t, ppu.v, 0x4000) // Fine Y = 4

    // Fine Y overflow (fine Y = 7, coarse Y increments)
    ppu = PPU{timing = console_timing_for_mode(.NTSC), v = 0x7000} // Fine Y = 7, coarse Y = 0
    ppu_increment_y(&ppu)
    testing.expect_value(t, ppu.v, 0x0020) // Fine Y = 0, coarse Y = 1

    // Wrap at coarse Y = 29 (switch vertical nametable)
    ppu = PPU{timing = console_timing_for_mode(.NTSC), v = 0x73A0} // Fine Y = 7, coarse Y = 29
    ppu_increment_y(&ppu)
    ...
    ppu = PPU{timing = console_timing_for_mode(.NTSC), v = 0x73E0} // Fine Y = 7, coarse Y = 31
    ppu_increment_y(&ppu)
    testing.expect_value(t, ppu.v, 0x0000) // Fine Y = 0, coarse Y = 0, nametable unchanged

    // Normal coarse Y increment
    ppu = PPU{timing = console_timing_for_mode(.NTSC), v = 0x71E0} // Fine Y = 7, coarse Y = 15
    ppu_increment_y(&ppu)
    testing.expect_value(t, ppu.v, 0x0200) // Fine Y = 0, coarse Y = 16

    // Preserve horizontal bits
    ppu = PPU{timing = console_timing_for_mode(.NTSC), v = 0x7FFF} // All bits set
    ppu_increment_y(&ppu)
...
test_transfer_x :: proc(t: ^testing.T) {
    ...
    ppu = PPU{timing = console_timing_for_mode(.NTSC), v = 0x7FFF, t = 0x0000}
    ppu_transfer_x(&ppu)
    ...
    ppu = PPU{timing = console_timing_for_mode(.NTSC), v = 0x0000, t = 0x041F}
    ppu_transfer_x(&ppu)
    ...
    // Mixed case
    ppu = PPU{timing = console_timing_for_mode(.NTSC), v = 0x7BE0, t = 0x001F}
    ppu_transfer_x(&ppu)
...
test_transfer_y :: proc(t: ^testing.T) {
    ...
    ppu = PPU{timing = console_timing_for_mode(.NTSC), v = 0x0000, t = 0x7BE0}
    ppu_transfer_y(&ppu)
    ...
    // Mixed case
    ppu = PPU{timing = console_timing_for_mode(.NTSC), v = 0x041F, t = 0x73E0}
    ppu_transfer_y(&ppu)
